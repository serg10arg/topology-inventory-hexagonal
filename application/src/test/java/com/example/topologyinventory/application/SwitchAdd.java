...
/** Step definitions de la feature SwitchAdd. */
public class SwitchAdd extends ApplicationTestData {
    ...
    public void i_provide_a_switch() {
        networkSwitch = Switch.builder()
                ...
                .location(locationA).switchType(SwitchType.LAYER3).build();
    ...
    public void i_add_the_switch_to_the_edge_router() {
        ...
        var expectedId = edgeRouter.getSwitches().get(Id.withId("f8c3de3d-1fea-4d7c-a8b0-29f63c4c3490")).getId();
